...
const initialTasks: Task[] = [
  {
    ...
    type: 'image',
    title: '心理健康小知識',
    description: '學習如何管理情緒壓力',
    points: 1,
    completed: false,
    content: '適度的壓力能激發潛能，但過度壓力會影響身心健康。學會深呼吸、冥想或運動來緩解壓力。'
  },
  {
    id: '2',
    type: 'video',
    title: '正向思維小短片',
    description: '3分鐘學會正向思考',
    points: 2,
    completed: false,
    content: '這是一部關於如何培養正向思維的短片，教你在困難時刻找到希望的光芒。'
  },
  {
    id: '3',
    type: 'question',
    ...
    points: 1,
    completed: false,
    content: '今天你想感謝誰？寫下一個讓你感謝的人或事物。'
  },
  {
    id: '4',
    type: 'image',
    title: '情緒調節技巧',
    description: '學習健康的情緒表達方式',
    points: 1,
    completed: false,
    content: '情緒是自然的，重要的是如何健康地表達。試著用文字記錄情緒，或與信任的人分享。'
  },
  {
    id: '5',
    type: 'question',
    title: '內在提問：自我關懷',
    description: '今天你為自己做了什麼好事？',
    points: 1,
    completed: false,
    content: '今天你為自己做了什麼好事？即使是很小的事情也值得肯定。'
  },
];
...
export function TaskCenter({ onNavigate, onAddPoints }: TaskCenterProps) {
  ...
  const getTaskTypeLabel = (type: string) => {
    switch (type) {
      case 'image': return '圖文學習';
      case 'video': return '影片觀看';
      case 'question': return '內在提問';
      default: return '任務';
    }
  };
